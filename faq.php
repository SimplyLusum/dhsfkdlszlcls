<?php include ("class/faq.class.php");

	$page=new Page($pgid); 
	$faq=new Faq();
    
    $sql = "select * from tbl_group_grp order by grp_order asc";
...
<div id="faq" class="general">
    ...
    <div id="faqs">
        ...
        <div id="tab_<?php echo $n+1; ?>">
            <?php $rs=$faq->get_list($idx); ?>
            <div class="left">
            ...
            <div class="right">
                ...
                <?php $i=1; foreach ($rs as $row) { ?>
                    <li><h2 id="question<?php echo $n."_".$i; ?>" class="question"><a href="javascript:faq_click('<?php echo $n."_".$i; ?>')"><?php echo $row['faq_title']; ?></a></h2>
                    <p id="answer<?php echo $n."_".$i; ?>" class="answer"><?php echo $row['faq_desc']; ?></p>
                    </li>
                <?php $i++; } ?>
                </ul>
            </div>

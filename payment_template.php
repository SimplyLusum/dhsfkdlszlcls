<? include ("class/payment_template.class.php");

	$page=new Page($pgid); 
	
	$template=new PaymentTemplate();
...
<div id="template" class="general">
	...
	<ul>
		...
		<li>
			...
			<div class="col2"><a href="upload/payment_images/<? echo $row['tmp_pic']; ?>" class="group"><img src="thumb.php?f=upload/payment_images/<? echo $row['tmp_pic']; ?>&w=179&h=133" /></a></div>
		</li>
		<? } ?>
	</ul>

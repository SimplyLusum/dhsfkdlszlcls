<?php 
	...
	switch ($action) {
		...
		case "edit":		
            ...
            $df->set_form("textarea","Grup Description","grp_description",$text['grp_description'],"class=\"textarea-full\" style=\"height:200px\"","");
            $df->set_form("text","Side column Title","grp_title",$text['grp_title'],"class=\"text-large\"","");
			$df->set_form("textarea","Side column Content","grp_desc",$text['grp_desc'],"class=\"textarea-full\" style=\"height:200px\"","");
